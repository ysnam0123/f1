import australiaAlbertPark from '/circuit/austrailia_albert_park.svg';
import chinaShanghai from '/circuit/china_shanghai.svg';
import japanSuzuka from '/circuit/japan_suzuka.svg';
import bahrainSakhir from '/circuit/bahrain.svg';
import saudiArabiaJeddah from '/circuit/saudi_arabia.svg';
import usaMiami from '/circuit/miami.svg';
import italyImola from '/circuit/italy_imola.svg';
import monacoMonteCarlo from '/circuit/monaco.svg';
import spainBarcelona from '/circuit/spain_barcelona.svg';
import canadaMontreal from '/circuit/canada.svg';
import austriaRedBullRing from '/circuit/austria_red_bull_ring.svg';
import ukSilverstone from '/circuit/united_kingdom_silverstone.svg';
import belgiumSpa from '/circuit/belgium.svg';
import hungaryHungaroring from '/circuit/hungary.svg';
import netherlandsZandvoort from '/circuit/netherlands_zandvoort.svg';
import italyMonza from '/circuit/italy_monza.svg';
import azerbaijanBaku from '/circuit/azerbijan_baku.svg';
import singaporeMarinaBay from '/circuit/singapore_marina_bay.svg';
import usaCota from '/circuit/usa_cota.svg';
import mexicoHermanosRodriguez from '/circuit/mexico.svg';
import brazilInterlagos from '/circuit/brazil_interlagos.svg';
import usaLasVegas from '/circuit/usa_las_vegas.svg';
import qatarLusail from '/circuit/qatar_lusail.svg';
import abuDhabiYasMarina from '/circuit/abu_dhabi_yas_marina.svg';
import spainMadrid from '/circuit/spain_madrid.svg';
