...
export default function SessionBox({ data }: PageProps) {
  ...
  return (
    <>
      <div className="flex h-full w-full flex-col items-center gap-3 rounded-[10px] border border-(--color-box-border) bg-(--color-box-bg) px-3 py-1 sm:px-5 sm:py-3">
        ...
        <button
          ...
          className="cursor-pointer rounded-[5px] border border-(--color-button-border) bg-(--color-button-bg) px-6 py-1.5 text-[12px] hover:bg-(--color-button-hover) active:bg-(--color-button-active) sm:h-10 sm:py-2 sm:text-[16px]"
        >
